...
/**
 * Builds instances to manage the layer configurations. Layer names are qualified with the workspace
 * name like this: workspace_name:layer_name
 * 
 * @author fergonco
 */
public interface LayerFactory {
   ...
   * @param layerName
   * @return
   * @throws IOException If the layer folder does not exist and cannot be created
   */
