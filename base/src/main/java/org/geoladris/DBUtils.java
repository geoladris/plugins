...
public class DBUtils {
  ...
  public static void processConnection(String resourceName, final DBProcessor processor)
  ...
  public static <T> T processConnection(String resourceName, ReturningDBProcessor<T> processor)
      throws PersistenceException {
